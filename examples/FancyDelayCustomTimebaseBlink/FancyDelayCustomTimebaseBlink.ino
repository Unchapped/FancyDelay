...
// Create a custom timebase function, that increments every second, instead of every ms
unsigned long sec_timebase(){
...
//create a two second delay using our new timebase
FancyDelay twoSec(2, sec_timebase);
